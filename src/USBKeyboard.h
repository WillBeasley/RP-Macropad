...
/*
 * Modified by William Beasely to extend key range to include F13-24
 *
*/

#ifndef USBKeyboard2_H
#define USBKeyboard2_H
 ...
 */
class USBKeyboard2: public USBHID, public ::mbed::Stream {
public:
    ...
    */
    USBKeyboard2(bool connect_blocking = true, uint16_t vendor_id = 0x1235, uint16_t product_id = 0x0050, uint16_t product_release = 0x0001);
    ...
    * @param product_release Your product_release
    */
    USBKeyboard2(USBPhy *phy, uint16_t vendor_id = 0x1235, uint16_t product_id = 0x0050, uint16_t product_release = 0x0001);
